...
impl DrumVoice {
    ...
    // ── Voices the other kits borrow ─────────────────────────────────────
    //
    // These keep the modifier-triple signature the nine shared kits call them
    // with. The 808's own voices above take the panel instead.
